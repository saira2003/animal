...
class porcinoPage extends StatefulWidget {
  @override
  _porcinoPageState createState() => _porcinoPageState();
}

class _porcinoPageState extends State<porcinoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Agregar Animal porcino')),
      body: Padding(
